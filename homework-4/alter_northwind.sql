...
SELECT * INTO discontinued_products_1 FROM products WHERE discontinued = 1;
...
-- P.S.  Хотел через SET DEFAULT, но тогда придется снимать primary key в таблице products,
-- чтоб отключить проверку уникальности.